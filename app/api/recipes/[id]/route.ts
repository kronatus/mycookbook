...
export async function GET(
  ...
  try {
    ...
    const result = await recipeService.getRecipeById(params.id, session.user.id);
...
export async function PUT(
  ...
  try {
    ...
    const result = await recipeService.updateRecipe(params.id, session.user.id, body);
...
export async function DELETE(
  ...
  try {
    ...
    const result = await recipeService.deleteRecipe(params.id, session.user.id);
